...
//                 <img src="./../assets/img/blog/details/6.jpg" alt="author" />
...
//                     pulvinar a. Vivamus magna justo, lacinia eget consectetur
//                     sed, convallis at tellus. Pellentesque in ipsum id orci
//                     porta dapibus.
//                   </p>
//                 </div>
//               </div>
              ...
              <div className="col-lg-8">
                <div className="post-detail-wrapper">
                  <div className="entry-content">
                    ...
                    <h4 className="entry-title">
                      I Will Not Reject My Faith in Rama, Shiva, Vishnu, Krishna
                      etc.
                    </h4>
                    <div className="sigma_post-meta">
                      <a href="blog-details.html">
                    ...
                    <p>
                      ...
                      Shiva, Vishnu, Krishna etc. Proin eget tortor industry's
                      standard dummy text ever since the 1500s, when an unknown
                      printer took a galley of type, People ask questions
                      related to Hinduism. specimen book. It has survived not
                    ...
                    <p>
                      ...
                      <a href="javascript:(void)">
                        people would likewise be unethical.
                      </a>{" "}
                      Our mission is to share the Good of Hinduism, Loving,
                      Faith and Serving. People ask questions related to
                      Hinduism. to make a type specimen book.
                    </p>
                    <a
                      href="./../assets/img/blog/details/1.jpg"
                    ...
                    <p>
                      ...
                      Bhagwan Ram, Shiva, Vishnu, Krishna etc. galley of type
                    ...
                    <h4>Should I Believe in Rebirth?</h4>
                    <p>
                      We never believe in reborn the Good of Hinduism, Loving,
                      Faith and Serving. People ask questions related to
                      Hinduism. Temple is a place where Hindu worship our
                      Bhagwan Ram, Shiva, Vishnu, Krishna etc. galley of type
                      and scrambled it to make a type specimen book. It has
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-lg-7 col-xl-8">
                        <p>
                          Temple is a place where Hindu worship our Bhagwan Ram,
                          Shiva, Vishnu, Krishna etc. Proin eget tortor
                          industry's standard dummy text ever since the 1500s,
                          when an unknown printer took a galley of type, People
                          ask questions related to Hinduism. specimen book. It
                    ...
                    <p>
                      Hindu teachers insist that believing in rebirth is
                      necessary for living an ethical life. Proin eget tortor
                      industry's standard dummy text ever since the 1500s, when
                      an unknown printer took a galley of type, People ask
                      questions related to Hinduism. specimen book. It has
                      survived not only five centuries, but also the leap into
                      electronic typesetting, remaining essentially unchanged.
                      It was popularised in the 1960s with the release of
                      Letraset sheets containing Lorem Ipsum passages, and more
                      ...
                      <div className="col-md-6">
                        <article className="sigma_post">
                          <div className="sigma_post-thumb">
                            <a href="blog-details.html">
                              <img
                                src="./../assets/img/blog/details/4.jpg"
                                alt="post"
                              />
                            </a>
                          </div>
                      ...
                      <div className="col-md-6">
                        <article className="sigma_post">
                          <div className="sigma_post-thumb">
                            <a href="blog-details.html">
                              <img
                                src="./../assets/img/blog/details/5.jpg"
                                alt="post"
                              />
                            </a>
                          </div>
